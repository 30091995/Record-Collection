...
class App extends Component {
  ...
  state = {
    ...
    return (
    <div className="App">
    {this.state.loggedInUser && this.state.loggedInUser.verifiedEmail ? <Route path="/" render={() => <NavigationBar user={this.state.loggedInUser} updateUser={this.updateUser}></NavigationBar>} /> : null }
